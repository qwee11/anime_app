            ...
            <div className="home-page__heading__main">
                <div>
                    ...
                    <p className='home-page__heading__main__info' >
                        ...
                        Repellat ullam et, inventore quos officiis magni doloribus
                        saepe cumque perspiciatis a esse harum error deserunt?
                        Repudiandae ratione quam nesciunt libero perspiciatis.
                    </p>
                </div>
            </div>
